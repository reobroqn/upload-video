...
def init_db() -> None:
    ...
    from app.models.video_category_association import (
        video_category_association,  # noqa: F401
    )
    from app.models.video_tag_association import video_tag_association  # noqa: F401
